...
function ProductList() {
    ...
    useEffect(() => {
        ...
        cartItems.forEach(item => {
            updatedDisabledButtons[item.name] = true;
        });
                        ...
                        <a href="#" onClick={handleCartClick} style={{ color: 'white', fontSize: '30px', textDecoration: 'none' }}>
                            <h1 className='cart'>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" id="IconChangeColor" height="68" width="68">
                                    ...
                                    <text x="50%" y="55%" textAnchor="middle" fill="white" fontSize="60">{totalQuantity}</text>
                                </svg>
                            </h1>
                        </a>
                    </div>
                                ...
                                {category.plants.map((plant) => (
                                    <div className="product-card" key={plant.name}>
                                        ...
                                        <button className="product-button" onClick={() => handleAddToCart(plant)} disabled={disabledButtons[plant.name]}>
                                            {disabledButtons[plant.name] ? 'Added to Cart' : 'Add to Cart'}
                                            </button>
                                    </div>
                                ))}
                            </div>
